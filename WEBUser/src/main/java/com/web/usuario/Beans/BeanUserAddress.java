...
public class BeanUserAddress  implements Serializable{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BeanUserAddress other = (BeanUserAddress) obj;
		if (CP == null) {
			if (other.CP != null)
				return false;
	...
	public String toString() {
		return "BeanUserAddress [streatName=" + streatName + ", extNumber=" + extNumber + ", intNumber=" + intNumber
